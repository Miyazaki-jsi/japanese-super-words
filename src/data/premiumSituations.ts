...
export const allPremiumSituations: PremiumSituationMeta[] = [
  ...
  },
  {
    ...
    category: 'traveler_essentials',
    sortOrder: 13,
    previewPhraseJa: '大きいロッカーは空いていますか？',
    previewPhraseEn: 'Is a large locker available?',
  },
  {
    id: 'vending_machine',
    title: '自販機',
    enTitle: 'Vending Machines',
    icon: CupSoda,
    category: 'traveler_essentials',
    sortOrder: 14,
    previewPhraseJa: 'これはホットですか？',
    previewPhraseEn: 'Is this one hot?',
  },
  {
    id: 'tourist_information',
    title: '観光案内所',
    enTitle: 'Tourist Information',
    icon: Info,
    category: 'traveler_essentials',
    sortOrder: 15,
  ...
  },
  {
    id: 'trash_carry_out',
    title: 'ゴミ・持ち帰り',
    enTitle: 'Trash & Carry-Out',
    icon: Trash2,
    category: 'daily_life',
    sortOrder: 10,
    previewPhraseJa: 'ゴミ箱はどこですか？',
    previewPhraseEn: 'Where is a trash can?',
  },
  {
    id: 'kaiten_sushi',
    title: '回転寿司',
    enTitle: 'Conveyor Belt Sushi',
    icon: UtensilsCrossed,
    category: 'daily_life',
    sortOrder: 11,
    previewPhraseJa: 'お皿はどこに返しますか？',
    previewPhraseEn: 'Where do I return the plates?',
  },
  {
    id: 'post_office',
    title: '郵便局',
  ...
  },
  {
    id: 'cabaret_club',
    title: 'キャバクラ',
    enTitle: 'Cabaret Club',
    icon: Sparkles,
    category: 'fun_nightlife',
    sortOrder: 10,
    previewPhraseJa: '初めてなんです。',
    previewPhraseEn: 'It is my first time.',
  },
  {
    id: 'tachinomi',
    title: '立ち飲み',
    enTitle: 'Standing Bar',
    icon: GlassWater,
    category: 'fun_nightlife',
    sortOrder: 11,
    previewPhraseJa: 'ビールを一杯ください。',
    previewPhraseEn: 'One beer, please.',
  },
  {
    id: 'photo_etiquette',
    title: '撮影マナー',
    enTitle: 'Photo Etiquette',
    icon: Camera,
    category: 'fun_nightlife',
    sortOrder: 12,
    previewPhraseJa: 'ここで写真を撮ってもいいですか？',
    previewPhraseEn: 'May I take photos here?',
  },
];
